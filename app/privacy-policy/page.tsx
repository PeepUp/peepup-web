    ...
    return (
        <div className="px-2 font-medium mb-8 md:px-20">
            ...
            <p className="py-4 text-base">
                <strong>At PeepUp</strong>, accessible from www.peepup.com, one of our
                main priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and recorded by
                PeepUp and how we use it. If you have additional questions or require more
                information about our Privacy Policy, do not hesitate to contact us.
            </p>

            <h2 className="text-xl mt-6 font-bold">Log Files</h2>

            <p className="py-4 text-base">
                PeepUp follows a standard procedure of using log files. These files log
            ...
            <h2 className="text-xl mt-6 font-bold ">Cookies and Web Beacons</h2>

            <p className="py-4 text-base">
                Like any other website, PeepUp uses "cookies". These cookies are used to
            ...
            <h2 className="text-xl font-bold  mt-6">Privacy Policies</h2>

            <p className="py-4 text-base">
                You may consult this list to find the Privacy Policy for each of the
                advertising partners of PeepUp.
            </p>

            <p className="py-4 text-base">
                Third-party ad servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective
                advertisements and links that appear on PeepUp, which are sent directly to
            ...
            <p className="py-4 text-base">
                Note that PeepUp has no access to or control over these cookies that are
                used by third-party advertisers.
            </p>

            <h2 className="text-xl mt-6 font-bold ">Third Party Privacy Policies</h2>

            <p className="py-4 text-base">
                PeepUp's Privacy Policy does not apply to other advertisers or websites.
            ...
            <h2 className="text-xl mt-6 font-bold ">Children's Information</h2>
            ...
            <p className="py-4 text-base">
                PeepUp does not knowingly collect any Personal Identifiable Information
            ...
            <h2 className="text-xl mt-6 font-bold ">Online Privacy Policy Only</h2>

            <p className="py-4 text-base">
                This Privacy Policy applies only to our online activities and is valid for
                visitors to our website with regards to the information that they shared
                and/or collect in PeepUp. This policy is not applicable to any information
                collected offline or via channels other than this website.
            </p>

            <h2 className="text-xl mt-6 font-bold ">Consent</h2>

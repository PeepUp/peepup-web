export default function Page() {
    return (
        <section
            className="flex flex-col justify-center items-center max-w-md mx-auto h-full text-sm text-justify pb-32"
            style={{
                minHeight: "calc(100vh - 6rem)",
            }}
        >
            <h1 className="text-2xl mb-12 font-semibold text-center">Privacy Policy</h1>
            <p
                className="mt-4"
                style={{
            ...
            >
                At PeepUp, accessible from www.peepup.com, one of our main priorities is
                the privacy of our visitors. This Privacy Policy document contains types
                of information that is collected and recorded by PeepUp and how we use it.
                If you have additional questions or require more information about our
                Privacy Policy, do not hesitate to contact us.
            </p>

            <h2 className="text-xl mt-6 font-semibold text-center">Log Files</h2>
            ...
            <h2 className="text-xl font-semibold text-center mt-6">Privacy Policies</h2>
            ...
            <h2 className="text-xl mt-6 font-semibold text-center">Consent</h2>

...
export default function Page() {
    return (
        <section
            className="flex flex-col justify-center items-center max-w-md mx-auto h-full text-sm pb-32 text-justify"
            style={{
        ...
        >
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold">1. Terms</h2>
            </div>
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold">2. Use License</h2>
            </div>
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold ">3. Disclaimer</h2>
            </div>
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold ">5. Revisions and Errata</h2>
            </div>
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold ">8. Your Privacy</h2>
            </div>
            ...
            <div className="justify-self-start w-full pl-8">
                <h2 className="text-xl mt-6 font-semibold ">9. Governing Law</h2>
            </div>
